...
def model_training():
    ...
    r_squareds.append(linear_model.score(data_big_features_test, data_big_target_test))
    ...
    r_squareds.append(tree_model.score(data_big_features_test, data_big_target_test))
    ...
    r_squareds.append(forest_model.score(data_big_features_test, data_big_target_test))
    ...
    r_squareds.append(boost_model.score(data_big_features_test, data_big_target_test))
    ...
    with torch.no_grad():
        ...
        r_squareds.append((1 - (loss.item() / torch.var(torch.tensor(data_big_target_test.values, dtype=torch.float32), unbiased=False))).item())
    ...
    neural_model_prediction = outputs.numpy().flatten()
